setTimeout(function () {
  ...
  function startScan() {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
          document.getElementById("info").innerHTML = "A threat has been detected. <br> Last scan: " +  date_time + "<br> 11 Threats found. <br> Scan lasted 0 minutes, 6 seconds. <br> 3821 files scanned. "
      }, 1000);
      setTimeout(function () {
          document.getElementById("bar").style.display = "none";
      }, 1000);
      setTimeout(function () {
          document.getElementById("re").innerHTML = "Quick scanned files.";
      }, 1000);
      setTimeout(function () {
